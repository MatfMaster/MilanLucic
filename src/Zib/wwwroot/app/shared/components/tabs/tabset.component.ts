...
@Component({
  ...
  `,
  styles: [
    '.tab-content { border: 2px solid #ddd; border-width: 0 1px 1px; /* Removes the top border */ padding: 20px;}'
  ]
})
...
export class TabsetComponent implements OnInit, OnDestroy {
  @Input() public get vertical():boolean { return this._vertical;};

  @Input() public get justified():boolean { return this._justified;};

  @Input() public get type():string {return this._type;};
