...
namespace Zib.Data.Migrations
{
    ...
    [Migration("20160811122856_PretnjeRanjivosti_DefaultMere")]
    partial class PretnjeRanjivosti_DefaultMere
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("Zib.Models.IntenzitetRanjivosti", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.ToTable("IntenzitetRanjivosti");
                });
            ...
            modelBuilder.Entity("Zib.Models.PretnjeRanjivosti_DefaultMere", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<int>("PretnjeRanjivostiId");

                    b.HasKey("Id");

                    b.HasIndex("MeraId");

                    b.HasIndex("PretnjeRanjivostiId");

                    b.HasIndex("PretnjeRanjivostiId", "MeraId")
                        .IsUnique();

                    b.ToTable("PretnjeRanjivosti_DefaultMere");
                });
            ...
            modelBuilder.Entity("Zib.Models.VrsteVrednosti_PretnjeRanjivosti", b =>
                {
                    ...
                    b.Property<int>("PretnjaPosleId");

                    b.Property<int>("PretnjaPreId");

                    b.Property<int>("PretnjaRanjivostId");

                    b.Property<int>("RanjivostPosleId");

                    b.Property<int>("RanjivostPreId");

                    b.Property<int>("VrstaVrednostiId");

                    b.HasKey("Id");

                    b.HasIndex("PretnjaPosleId");

                    b.HasIndex("PretnjaPreId");

                    b.HasIndex("PretnjaRanjivostId");

                    b.HasIndex("RanjivostPosleId");

                    b.HasIndex("RanjivostPreId");
            ...
            modelBuilder.Entity("Zib.Models.VrsteVrednosti_PretnjeRanjivosti", b =>
                {
                    b.HasOne("Zib.Models.IntenzitetPretnje", "PretnjaPosle")
                        .WithMany("VrsteVrednosti_PretnjeRanjivosti_Posle")
                        .HasForeignKey("PretnjaPosleId");

                    b.HasOne("Zib.Models.IntenzitetPretnje", "PretnjaPre")
                        .WithMany("VrsteVrednosti_PretnjeRanjivosti_Pre")
                        .HasForeignKey("PretnjaPreId");
                    ...
                    b.HasOne("Zib.Models.IntenzitetRanjivosti", "RanjivostPosle")
                        .WithMany("VrsteVrednosti_PretnjeRanjivosti_Posle")
                        .HasForeignKey("RanjivostPosleId");

                    b.HasOne("Zib.Models.IntenzitetRanjivosti", "RanjivostPre")
                        .WithMany("VrsteVrednosti_PretnjeRanjivosti_Pre")
                        .HasForeignKey("RanjivostPreId");
